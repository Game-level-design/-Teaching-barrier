...
var ItemPackageControl = {
	...
	getItemUseParent: function(item) {
		...
		// getItemSelectionObjectやgetItemInfoObjectと異なり、
		// RecoveryItemUseなどを返すのではなく、
...
// ItemUseParentが使用される前に、
// BaseItemSelectionが使用されているとは限らない点に注意。
...
// 敵軍がアイテムを使用する場合はAI処理も統合されているBaseItemAIが参照される。
