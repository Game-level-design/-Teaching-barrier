...
var QuestDetailWindow = defineObject(BaseWindow,
{
	...
	_drawSentenceZone: function(x, y) {
		...
		x = (x + this._width) - ((this.getTitlePartsCount() + 2) * TitleRenderer.getTitlePartsWidth());
		y += 5;
		for (i = 0; i < count; i++) {
...
var BaseQuestSentence = defineObject(BaseObject,
{
	...
	_drawTitle: function(x, y) {
		...
		if (pic !== null) {
			this._drawTitleInternal(pic, x, y, width, height, this._detailWindow.getTitlePartsCount());
		}
	},
