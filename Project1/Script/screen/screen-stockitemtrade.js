...
var StockCategory = defineObject(BaseScrollbar,
{
	...
	checkStockCategory: function(stockItemWindow) {
		var obj, scrollbar;
		var index = -1;
		...
		if (index !== -1) {
			scrollbar = stockItemWindow.getItemScrollbar();
			...
			obj = this._arr[index];
			stockItemWindow.setStockItemFormationFromWeaponType(obj.weaponType);
