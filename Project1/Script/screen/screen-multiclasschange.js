...
{
	drawScreenBottomText: function(textui) {
		var metamorphozeData = this._classEntryArray[this._currentIndex].metamorphozeData;
		
		if (metamorphozeData !== null) {
			TextRenderer.drawScreenBottomText(metamorphozeData.getDescription(), textui);
		}
		else {
