...
var UnitSortieScreen = defineObject(BaseScreen,
{
	...
	_drawSortieText: function(textui) {
		...
		range = createRangeObject(x + 35, root.getGameAreaHeight() - 58, 405, 40);
		TextRenderer.drawRangeText(range, TextFormat.CENTER, text, -1, color, font);
		
		this._drawMemberData(x + 370, root.getGameAreaHeight() - 50, textui);
	},
...
{	
	...
	_getSortieColor: function(object) {
		var color;
